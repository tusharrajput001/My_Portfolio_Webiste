    ...
    <div className='skills-boss'>
        <div className='skills-card-container'>
            ...
            <div className='skills-base'>
                ...
                <Skill_icon name={"Vite"} link={"https://icon.icepanel.io/Technology/svg/Vite.js.svg"}/>
                <Skill_icon name={"Tkinter"} link={"https://cdn3.iconfinder.com/data/icons/doodle-education/100/education-15-256.png"}/>
        ...
        <div className='skills-card-container'>
            ...
            <div className='skills-base'>
                ...
                <Skill_icon name={"C++"} link={"https://cdn0.iconfinder.com/data/icons/programming-1-1/32/Programming_C-3-256.png"}/>
